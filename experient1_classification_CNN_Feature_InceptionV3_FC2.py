...
# ====================================================================    
train_folder = os.path.join(directory_work, 'train_Deep_Features/inceptionv3_features')
test_folder = os.path.join(directory_work, 'test_Deep_Features/inceptionv3_features')
